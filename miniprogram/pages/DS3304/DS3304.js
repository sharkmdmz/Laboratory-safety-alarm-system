Page({
  ...
  navigateToDetail: function() {
    wx.navigateTo({
      url: '/pages/DS3304/DS3304_detail/DS3304_detail'
    });
  },

  navigateToRecord: function() {
    wx.navigateTo({
      url: '/pages/DS3304/DS3304_record/DS3304_record'
    });
  },
  ...
  navigateToCamera: function(e) {
    ...
    wx.navigateTo({
      url: `/pages/DS3304/DS3304_camera${camera}/DS3304_camera${camera}?videoSrc=${this.data.videoSrc}`
    });
  },
